...
void forward_gru_layer(layer l, network_state state)
{
    ...
    input_z_layer = *(l.input_z_layer);
    input_r_layer = *(l.input_r_layer);
    input_h_layer = *(l.input_h_layer);

    state_z_layer = *(l.state_z_layer);
    state_r_layer = *(l.state_r_layer);
    state_h_layer = *(l.state_h_layer);
