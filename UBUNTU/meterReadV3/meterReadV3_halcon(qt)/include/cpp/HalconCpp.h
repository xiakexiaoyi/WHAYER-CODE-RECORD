...
# pragma message ("WARNING: HALCON/C++ (legacy) is deprecated and will not be " \
                  "supported as of the HALCON major version after the next major version.")
#endif
