...
void test_dunion()
{
	float inter,xinter,yinter,winter,hinter;
    box a = {0, 0, 1, 1};
...
int do_nms_sortR(box *boxes, float **probs, int total, int classes, float thresh)
{
    int i, j, k;
	int res=0;
...
{
    box encode;
   /* encode.x = (b.x - anchor.x) / anchor.w;     //vs2015  log2º¯Êý
