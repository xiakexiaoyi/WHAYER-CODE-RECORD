...
#define SOURCE_ROAD	"C://yucaibian_video//2017-01-11//192.168.1.97_01_20170111154843533.mp4"
...
#else
	pFrame = cvLoadImage("D:\\a.jpg", CV_LOAD_IMAGE_COLOR);
#endif
...
//	cvNamedWindow("testImage",0);
	...
	else
	{
		...
		if(1==lTmpVal)
		{
			...
			pOutPattern->lLineColor[1] = HY_LINE_BLACK;
		}
		else if(2==lTmpVal)
		{
