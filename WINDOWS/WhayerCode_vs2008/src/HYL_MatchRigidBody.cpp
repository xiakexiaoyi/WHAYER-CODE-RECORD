...
#include "Match\MatchRigidBody.h"
...
MRESULT HYL_GetDashboard(MHandle HYLHandle,HYL_PIMAGES pImage,MChar *pClassName,MDouble threshold,PMPOINT offset)
{
	...
	//printf("1:offset->x=%d offset->y=%d outParam.lX=%d outParam.lY=%d\n",offset->x,offset->y,outParam.lX,outParam.lY);
	...
	//printf("2:offset->x=%d offset->y=%d outParam.lX=%d outParam.lY=%d\n",offset->x,offset->y,outParam.lX,outParam.lY);
	offset->x=outParam.lX;
	offset->y=outParam.lY;
	//printf("3:offset->x=%d offset->y=%d outParam.lX=%d outParam.lY=%d\n",offset->x,offset->y,outParam.lX,outParam.lY);
