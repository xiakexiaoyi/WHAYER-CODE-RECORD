...
int ProtectionLinkTrain(HYED_RESULT_LIST *resultlist)
{
	...
	printf("交互完成\n");
	/*resultlist->lAreaNum=6;
	resultlist->DtArea[0].left=424;
	resultlist->DtArea[0].top=89;
	resultlist->DtArea[0].right=1564;
	resultlist->DtArea[0].bottom=734;
	resultlist->DtArea[1].left=455;
	resultlist->DtArea[1].top=131;
	resultlist->DtArea[1].right=521;
	resultlist->DtArea[1].bottom=274;
	resultlist->DtArea[2].left=616;
	resultlist->DtArea[2].top=131;
	resultlist->DtArea[2].right=677;
	resultlist->DtArea[2].bottom=273;
	resultlist->DtArea[3].left=776;
	resultlist->DtArea[3].top=127;
	resultlist->DtArea[3].right=832;
	resultlist->DtArea[3].bottom=277;
	resultlist->DtArea[4].left=930;
	resultlist->DtArea[4].top=130;
	resultlist->DtArea[4].right=984;
	resultlist->DtArea[4].bottom=277;
	resultlist->DtArea[5].left=1083;
	resultlist->DtArea[5].top=131;
	resultlist->DtArea[5].right=1133;
	resultlist->DtArea[5].bottom=269;*/
