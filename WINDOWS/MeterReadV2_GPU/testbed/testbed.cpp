...
#ifdef _DEBUG
#pragma comment(lib, "../../lib/win32/HYMeterRecogd.lib")
#else
#endif
...
#define MR_MEM_SIZE (25*1024*1024)
...
void printMeter();
void printRid();
//void ReleaseDescriptors(HYMRB_PTDescriptors ptDescriptors);
...
//	CvCapture *pCapture = MNull;
	...
	pFrame = cvLoadImage(SOURCE_ROAD, CV_LOAD_IMAGE_COLOR);
...
//***************************  get video  ******************************************************
	...
	while(lFrameNum < 100)
	{
		...
		if (HY_OIL_TEMPERATURE==lMeterType || HY_OIL_METER==lMeterType || HY_VOLT_METER==lMeterType || HY_SF6_GAS_METER==lMeterType)
		{
