...
#define SOURCE_JPG  "H://0910//030.png"
...
//***********************  alloc memory  *******************************
	...
	if(0!=HYMR_Init(NULL,&hTLHandle))//new add
	{
...
//***************************  get video  ******************************************************
	...
	w=ImgSize.width;
	h=ImgSize.height;
	if(0!=HYMR_SetParam(hTLHandle,cfgfile,weightfile,thresh,w,h))//new add
	{
	...
	while(1)
	{
		...
		if(0!=HYMR_meterRecog(hTLHandle,&imgs,&resultlist))	 //new add
		{
			printf("未找到目标\n");
